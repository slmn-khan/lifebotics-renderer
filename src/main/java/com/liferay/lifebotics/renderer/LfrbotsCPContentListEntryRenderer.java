...
@Component(
		immediate = true,
		property = {
				"commerce.product.content.list.entry.renderer.key=" + LfrbotsCPContentListEntryRenderer.KEY,
...
public class LfrbotsCPContentListEntryRenderer implements CPContentListEntryRenderer {
	public static final String KEY = "lfrbots-catalog";
